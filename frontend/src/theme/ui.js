...
export const inputCls = (theme) =>
  `w-full rounded-lg border py-2.5 px-3 text-sm outline-none transition-colors ${
    theme === "dark"
...
export const primaryButton =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-blue-500 active:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50 border border-transparent";

export const secondaryButton = (theme) =>
  theme === "dark"
    ? "inline-flex items-center justify-center rounded-lg border border-slate-600 bg-slate-800 px-4 py-2.5 text-sm font-medium text-slate-200 hover:bg-slate-700/80 transition-colors"
    : "inline-flex items-center justify-center rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-800 hover:bg-slate-50 transition-colors";
